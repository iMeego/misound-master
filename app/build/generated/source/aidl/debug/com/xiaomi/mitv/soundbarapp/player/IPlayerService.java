 ...
 * Original file: E:\\Android\\workspace\\misound-master\\app\\src\\main\\aidl\\com\\xiaomi\\mitv\\soundbarapp\\player\\IPlayerService.aidl
 */
package com.xiaomi.mitv.soundbarapp.player;
public interface IPlayerService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.xiaomi.mitv.soundbarapp.player.IPlayerService
{
private static final java.lang.String DESCRIPTOR = "com.xiaomi.mitv.soundbarapp.player.IPlayerService";
...
/**
 * Cast an IBinder object into an com.xiaomi.mitv.soundbarapp.player.IPlayerService interface,
 * generating a proxy if needed.
 */
public static com.xiaomi.mitv.soundbarapp.player.IPlayerService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.xiaomi.mitv.soundbarapp.player.IPlayerService))) {
return ((com.xiaomi.mitv.soundbarapp.player.IPlayerService)iin);
}
return new com.xiaomi.mitv.soundbarapp.player.IPlayerService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.xiaomi.mitv.soundbarapp.player.IPlayerService
{
...
static final int TRANSACTION_setRepeatMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_getRepeatMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_getMediaMountedCount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_getAudioSessionId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
}
